...
The goal of this repo/repository is to help beginners who are doing their first pull requests. Feel free to join!
...
# How to Create a Pull Request
  ...
  - Click on the fork on the top to fork this repo./respository.
  - Go to your repo/repository where you forked the project.
  - Hit the clone button on your forked repo/repository and copy the given link.
  ...
  - Go back to the original repo./repository.
