...
# How to Create a Pull Request
  ...
  - On your terminal / command prompt, type "git clone [copied link]".
  - Change the index file in the folder and save it.
  - Afterward, on your terminal / command prompt, type "git add index.html"; then 'git commit -m
   "[type a message]" '.
