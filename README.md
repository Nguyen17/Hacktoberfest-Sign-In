...
# How to Create a Pull Request
  ...
  - Afterward, on your terminal / command prompt, type 
  ```
  git add index.html
  ```
  then 
  ...
  ```
  - Create a remote to link the repository on github to your local workspace. use 
  ```
  git remote add [remote-name] [put the github link here]
  ```
  - Push the commit. For example, type 
  ```
